# Dromex (via Metamedia) — SA Rugby Mag, Rugby Championship flight
...
Dromex on SA Rugby Mag — 21 Aug to 21 Oct at R50,000 p/m
...
The Springboks are back on the park this Saturday, 22 August. The provincial
season has just wrapped and it did not go our way at all — which, if anything,
has only sharpened the appetite for this one. Four Tests fall inside the next
two months, the All Blacks fixtures among them, and that stretch is the
highest-traffic window SA Rugby Mag has all year.

I would like to keep Dromex live right through it.

**The offer**

- The same package Dromex ran in June — 728x90 leaderboard and 300x250 MPU,
...
868,344 impressions and 1,340 clicks at a 0.15% CTR — the full contracted
volume, goal met, with no material under-delivery across the month. The Winter
Range creative added roughly 42,300 views and reached about 31,000 accounts on
social off a single boosted Reel. At R50,000 the same delivery profile puts
Dromex at roughly 17 impressions per rand, against 13.4 in June.

June also showed the pattern clearly: impressions spiked on match days. Booking
the Test window rather than a calendar month is the single biggest lever we have
on this account.

Creative from the June flight is still with us, so if Dromex is happy to re-run
it we can be live on Friday. New material would need to reach me by Thursday
20 August.

May I raise the booking order for Metamedia on behalf of Dromex South Africa so
that we are live before Saturday's kick-off?
...
| Figure | Source |
| --- | --- |
| 868,344 impressions · 1,340 clicks · 0.15% CTR | `public/campaign-report.html` — DATA.metrics, GAM line item 7295013789 |
| R65,000 June spend · R74.86 CPM · 13.4 impressions per rand | `public/campaign-report.html` — DATA.commercials |
| 42.3K social views · 31.0K accounts reached | Meta Business Suite, "#Sponsored / Winter Range", published 28 Jun 2026 |
| 17.4 impressions per rand at R50,000 | 868,344 / 50,000 — assumes June delivery repeats; not contracted |
| Contact, agency entity, prior deal value | `public/habari-proposal-tracker.html` — SEED record id 7 |
